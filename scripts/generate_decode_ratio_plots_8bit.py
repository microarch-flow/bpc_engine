...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config-dir",
        type=Path,
        default=PROJECT_ROOT / "configs" / "8bit",
        help="Directory containing model JSON configs.",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=PROJECT_ROOT / "outputs" / "decode_ratio" / "8bit",
